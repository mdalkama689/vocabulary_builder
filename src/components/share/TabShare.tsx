...
const TabShare = () => {
  const [isHovered, setIsHovered] = useState(false);
   ...
   "I found this useful vocabulary builder tool, check it out: https://seosaurus.in/tools/vocabulary-builder-quiz/"
  );

  const toolUrl = "https://seosaurus.in/tools/vocabulary-builder-quiz/";
